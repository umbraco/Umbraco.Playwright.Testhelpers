...
export class ElementApiHelper {
  ...
  async create(document) {
    ...
    const response = await this.api.post(this.api.baseUrl + '/umbraco/management/api/v1/element', document);
  ...
  async getAllAtRoot() {
    return await this.api.get(this.api.baseUrl + '/umbraco/management/api/v1/tree/element/root?skip=0&take=10000');
  }
  ...
  async getDocumentUrl(id: string) {
    const response = await this.api.get(this.api.baseUrl + '/umbraco/management/api/v1/element/urls?id=' + id);
  ...
  async getDomains(id: string) {
    const response = await this.api.get(this.api.baseUrl + '/umbraco/management/api/v1/element/' + id + '/domains');
    return await response.json();
  }

  async updateDomains(id: string, domains) {
    return await this.api.put(this.api.baseUrl + '/umbraco/management/api/v1/element/' + id + '/domains', domains);
  }
  ...
  async getNotifications(id: string) {
    const response = await this.api.get(this.api.baseUrl + '/umbraco/management/api/v1/element/' + id + '/notifications');
    return await response.json();
  }
  ...
  async updatetNotifications(id: string, subscribedActionIds: string[] = []) {
    ...
    return await this.api.put(this.api.baseUrl + '/umbraco/management/api/v1/element/' + id + '/notifications', updateData);
  }
