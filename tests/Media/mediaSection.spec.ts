...
test.describe('Media', () => {
    ...
    test('move one of each Files into a Folder', async ({page, umbracoApi, umbracoUi}) => {
        ...
        const mediaFileTypes = [
            {fileTypeNames: 'ArticleToMove'},
            {fileTypeNames: 'AudioToMove'},
            {fileTypeNames: 'FileToMove'},
            {fileTypeNames: 'ImageToMove'},
            {fileTypeNames: 'VectorGraphicsToMove'},
            {fileTypeNames: 'VideoToMove'}
        ]
